...
public class ChatDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.cameraButton).setOnClickListener(v -> {
            Intent intent = new Intent(ChatDetailActivity.this, CameraActivity.class);
        ...
        findViewById(R.id.profileButton).setOnClickListener(v -> {
            if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                ...
                Toast.makeText(ChatDetailActivity.this, "You must be logged in to view your profile", Toast.LENGTH_SHORT).show();
                // Optionally navigate to login screen
                Intent intent = new Intent(ChatDetailActivity.this, AuthActivity.class);
                startActivity(intent);
            }
        });
    }
